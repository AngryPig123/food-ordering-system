...
import com.food.ordering.system.domain.valuobject.CustomerId;
import com.food.ordering.system.domain.valuobject.Money;
import com.food.ordering.system.domain.valuobject.ProductId;
        ...
        return orderItems.stream()
                .map(orderItem ->
                        OrderItem.Builder.builder()
                                ...
                                .subTotal(new Money(orderItem.getSubPrice()))
                                .build()
                )
                .toList();
    }
